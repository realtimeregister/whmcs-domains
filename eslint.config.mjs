...
export default defineConfig([
  ...
  {
    files: ["modules/registrars/realtimeregister/tests/**/*.js"], languageOptions: { sourceType: "module" }
  },
  {
    files: ["modules/registrars/realtimeregister/src/**/*.js"], languageOptions: { sourceType: "script" }
  },
  {
    rules: {
