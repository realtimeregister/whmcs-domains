<div id="app">
    <p>
        ...
        Domain attributes like expiry date and status will be copied automatically. The importer will match up domain registrant data with existing clients, or create new clients if no match is found.
    </p>

    <div class="stepwizard-row">
        <div class="stepwizard-step">
            <button type="button" class="btn btn-default btn-circle btn-primary disabled">Setup</button>
        </div>
        <div class="stepwizard-step">
            <button type="button" class="btn btn-default btn-circle btn-primary disabled">Confirm</button>
        </div>
        <div class="stepwizard-step">
                ...
                <div class="col-sm-12 col-md-10 col-lg-10">
                    ...
                    <form class="step-one-form">
                        <fieldset class="form-group">
                            ...
                            <small class="form-text text-muted">Please choose whether you want to import all domains from your Realtime Register account, or specify a list of domains you would like to import.</small>
                        </fieldset>
                        ...
                        <fieldset class="form-group">
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" id="allBrands" value="all" name="brandSelection" onchange="setBrandSelection('all')">
                                    Import all brands as clients.
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" id="brandselection_list" value="list" name="brandSelection" onchange="setBrandSelection('list')">
                                    Import a list of brands as clients (brands that are not selected will be imported the default way; contacts will be clients).
                                </label>
                            </div>
                        ...
                        <div class="brand-selection-list hidden">
                            <a href="#" onclick="selectAllBrands()" title="Select all">Select all</a> / <a href="#" onclick="brandSelectionList = []; return false;" title="Deselect all">Deselect all</a>
                            <fieldset>
                                    ...
                                    <ul class="brand_overview" style="margin-top: 0;">
                                        {foreach from=$fields['allBrands'] item=brand}
                                            <li>
                                                ...
                                                >
                                                <label style="font-weight: normal;" for="{$brand.handle}">{$brand.organization} - {$brand.email} <small class="d-none d-lg-block" style="color: #8d8d8d;">{$brand.handle}</small></label>
                                            </li>
                                        {/foreach}
                                    </ul>
                                {else}
                        ...
                        <fieldset class="form-group">
                            {if !empty($fields['gateways'])}
                                ...
                                <small class="form-text text-muted">Select preferred payment method that you want to use within WHMCS.</small>
                            {else}
                                <strong style="color: red;">In order to use the import functionality, please set up a payment gateway</strong>
                            {/if}
                        </fieldset>
...
<script type='text/javascript'>
    ...
    function getSelectedBrands() {
        switch (brandSelectionMethod) {
            case 'all': return allBrands.map(brand => brand.handle);
            case 'list': {
